                  ...
                  <section className="mt-4 flex items-center justify-between">
                    <div className="inline-flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-white/30 bg-white/60 hover:text-black shadow backdrop-blur transition hover:bg-white dark:bg-white/10 dark:text-white"
                      >
